...
module.exports.alias = function(route, method) {
  if(pathMap[route]) {
    ...
    // If route is not registered via module
    // - Log error or throw error depends on where this function is called
    console.log("Route is not registerd via module!");
    throw new Error("Route is not registerd via module!");
  }
}